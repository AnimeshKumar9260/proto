...
export default function PrvtLtdHero() {
  ...
  return (
    <div
      style={{
        backgroundImage: "url(./pvtltdbanner.jpg)",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="w-full overflow-hidden grid grid-cols-1 md:grid-cols-[2fr_1fr] bg-gradient-to-tr from-[#333333] to-[#333]/50">
        <div className="px-4 py-8 md:px-14 md:py-10 w-full h-full flex  justify-center flex-col">
          ...
          <p className="text-xl text-slate-200 mb-8">
            ...
            <span className="underline decoration-[2px] underline-offset-4 decoration-[#FCA229] font-[600]">
              7 days
            </span>{" "}
            at{" "}
            <span className="underline decoration-[2px] underline-offset-4 decoration-[#FCA229] font-[600]">
            ...
            {checkData.map((item, index) => (
              <div key={index} className="flex items-center gap-2">
                <input
                  ...
                  className="accent-[#FCA229] h-6 w-6 pointer-events-none"
                />
          ...
          <div className="flex gap-8">
            <button className="px-6 py-3 w-fit bg-[#1E446C] hover:bg-[#1E446C] duration-300 rounded font-[600] text-[#eee]">
              Call Us
            </button>
            <button className="px-6 py-3 w-fit bg-[#1E446C] hover:bg-[#1E446C] duration-300 rounded font-[600] text-[#eee]">
              Whatsapp Us
